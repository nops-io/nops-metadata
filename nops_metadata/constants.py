...
METAMAP = freeze(
    OrderedDict({
        "autoscaling_auto_scaling_groups": {"fetch_method": "describe_auto_scaling_groups",
                                            "response_key": "AutoScalingGroups"},
        "cloudformation_stacks": {"fetch_method": "describe_stacks", "response_key": "Stacks"},
        "cloudfront_distributions": {"fetch_method": "list_distributions", "response_key": "Items",
                                     "page_key": "DistributionList"},
        "cloudtrail_trails": {"fetch_method": "describe_trails", "response_key": "trailList"},
        "config_configuration_recorder_status": {"fetch_method": "describe_configuration_recorder_status",
                                                 "response_key": "ConfigurationRecordersStatus"},
        "config_configuration_recorders": {"fetch_method": "describe_configuration_recorders",
                                           "response_key": "ConfigurationRecorders"},
        "config_delivery_channel_status": {"fetch_method": "describe_delivery_channel_status",
                                           "response_key": "DeliveryChannelsStatus"},
        ...
        "ec2_instances": {"fetch_method": "describe_instances", "page_key": "Reservations",
        ...
        "ec2_reserved_instances_modifications": {"fetch_method": "describe_reserved_instances_modifications",
                                                 "response_key": "ReservedInstancesModifications"},
        ...
        "ec2_snapshots": {"fetch_method": "describe_snapshots", "response_key": "Snapshots",
        ...
        "elasticache_replication_groups": {"fetch_method": "describe_replication_groups",
                                           "response_key": "ReplicationGroups"},
        "elasticache_cache_subnet_groups": {"fetch_method": "describe_cache_subnet_groups",
                                            "response_key": "CacheSubnetGroups"},
        ...
        "iam_account_password_policy": {"fetch_method": "get_account_password_policy",
                                        "response_key": "PasswordPolicy"},
        ...
        "rds_pending_maintenance_actions": {"fetch_method": "describe_pending_maintenance_actions",
                                            "response_key": "PendingMaintenanceActions"},
        ...
        "resourcegroupstaggingapi_resources": {"fetch_method": "get_resources",
                                               "response_key": "ResourceTagMappingList"},
        "s3_buckets": {"fetch_method": "list_buckets", "response_key": "Buckets"},
        "ssm_compliance_summaries": {"fetch_method": "list_compliance_summaries",
                                     "response_key": "ComplianceSummaryItems"},
        "workspaces_workspace_directories": {"fetch_method": "describe_workspace_directories",
                                             "response_key": "Directories"},
        "workspaces_workspaces": {"fetch_method": "describe_workspaces", "response_key": "Workspaces"},
        "ec2_spot_fleet_requests": {"fetch_method": "describe_spot_fleet_requests",
                                    "response_key": "SpotFleetRequestConfigs"},
    })
)
...
SUBRESOURCES_METAMAP = freeze(
    OrderedDict({
        ...
        "spot_fleet_instances": {
            "fetch_method": "describe_spot_fleet_instances",
            "response_key": "ActiveInstances",
            "parent_required_filters": {
                "filter_key": "SpotFleetRequestId",
                "parent_filter_field": "SpotFleetRequestId",
                "parent_metadata_type": "ec2_spot_fleet_requests",
            }
        }
    })
)
